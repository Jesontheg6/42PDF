...
\chapter{Introduction}
	...
	\warn{
		If you are using Python or another language
		 make sure to research into Python's equivalent
...
\chapter{General instructions}
	...
	\begin{itemize}
		...
		\hint{
			It will help you a lot to practice writing your parent and
			child class first. After that you can focus on writing
...
\chapter{Mandatory part}
	...
	\end{center}
		...
		\hint{
			...
			designing something simple so that it is easy to repeatedly call
			the menu and to add stuff to the menu.
		}
